            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/dashboard')); ?>">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="<?php echo e(url('plugins/images/logo-icon.png')); ?>" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php if(Auth::user()->role== 'admin'): ?>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link  <?php if(Request::is('mahasiswa*')): ?> active <?php endif; ?>"
...
<?php /**PATH C:\xampp2\htdocs\UAS-Sistem_Informasi_EBisnis-20200121018-Rizky-Ramadhan-master\UAS-Sistem_Informasi_EBisnis-20200121018-Rizky-Ramadhan-master\resources\views////layouts/mainapp.blade.php ENDPATH**/ ?>